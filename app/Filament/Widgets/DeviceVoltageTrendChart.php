...
class DeviceVoltageTrendChart extends ApexChartWidget
{
     ...
     * @var string
     */
    protected static ?string $chartId = 'device-voltage-chart';
    ...
    {
        $data1 = $event['deviceStatus']['voltage1'];
    ...
    {
        $data = DeviceMatrixService::getDeviceTrend($this->deviceId, ['created_at', 'voltage1', 'voltage2']);
        if ($data->count() > 0) {
            $this->data['data'] = [
                [
                    'name' => 'Voltage 1',
